        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Detail BOM Sample</h1>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="tgl_bom" class="text-primary"><b>Tanggal</b></label><br>
                                            <label><?= date('d/m/Y', strtotime($bom->tanggal_bom_sample)) ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label for="produk" class="text-primary"><b>Nama Produk</b></label><br>
                                            <label><?= $bom->permintaan_sample_awal ?></label>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        &nbsp;
                                    ...
                                    <div class="col-3">
                                        <div class="form-group"> 
                                            ...
                                            <label><?= $bom->kode_bom_sample ?></label>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="jumlah_produksi" class="text-primary"><b>Volume</b> (Kg/pcs)</label><br>
                                            <label><?= number_format($bom->volume_sample_awal/1000,2,',','.') ?> Kg</label>
                                        </div>
                                    </div>
                                </div>
                                <hr>    
                                ...
                                <div class="row ml-0">
                                        <div class="col-6">
                                            ...
                                            <label><?= $bom->ket_bom_sample ?></label>
                                        </div>
                                </div>
                            </div>
                        </div>
