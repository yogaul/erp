        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Buat BOM Sample</h1>

                    <!-- DataTales Example -->
                    <form action="<?php echo base_url().'sample/simpan_bom' ?>" method="post" id="form-bom" enctype="multipart/form-data">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id_sample" value="<?= $id ?>">
                                            <input type="hidden" name="volume_produk" id="volume_produk_pcs" value="<?= $data->volume_sample_awal/1000 ?>">
                                            <input type="text" name="nama_produk" required="" class="form-control" value="<?= $data->permintaan_sample_awal ?>" readonly>
                                        </div>
                                        <div class="form-group"> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <a href="#!" class="btn btn-sm btn-primary float-right mt-2" id="simpan-pilih">Masukkan Bahan <i class="fa fa-arrow-down"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="volume_produk" class="text-primary"><b>Volume Produk</b> (Kg)</label>
                                            <input type="text" name="volume_produk_text" required="" class="form-control" value="<?= number_format($data->volume_sample_awal/1000,2,',','.') ?>" readonly>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="deskripsi_formula" class="text-primary"><b>Catatan</b></label>
                                            <textarea name="deskripsi_formula" rows="6" class="form-control" placeholder="Tambahkan catatan..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>    
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="dokumen_formula" class="text-primary"><b>Dokumen Formula</b></label>
                                            <input type="file" name="dokumen_formula" class="form-control-file">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
