        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Buat Surat Perintah Pengiriman (SPP)</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <form action="<?php echo base_url().'spp/simpan_spp' ?>" method="POST">
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="no_spp" placeholder="No. SPP..." required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="no_telp_kirim_spp" class="form-control form-control-sm" name="no_telp_pengiriman" placeholder="No. Telp..." required="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                         <div class="form-group">
                                            <label for="alamat_pengiriman" class="text-primary"><b>Alamat Pengiriman</b></label>
                                            <input type="text" id="alamat_kirim_spp" class="form-control form-control-sm" name="alamat_pengiriman" placeholder="Alamat Pengiriman..." required="">
                                        </div>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <textarea name="catatan_spp" class="form-control" placeholder="Catatan surat perintah pengiriman..." rows="4"></textarea>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-6">&nbsp;</div>
    ...
    $(document).ready(function() {
        ...
        $(".delete-row").click(function(){
            ...
            $('input[name="record[]"]:checked').each(function() {   
                ...
                if($('#data_produk').html() == ""){
                    $("#data_produk").html('<tr><td colspan="5" align="center" class="dataTables_empty">Tidak ada tujuan yang di pilih</td></tr>');
                    $('.delete-row').attr('hidden', 'true');
                }
            });
            // status_table();
