                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <label><?= date('d/m/Y', strtotime($bom->tanggal_bom_produk)) ?></label>
                                        </div>
                                        <div class="form-group">
                                            <label for="produk" class="text-primary"><b>Nama Produk</b></label><br>
                                            <label><?= $bom->nama_produk_msglow ?></label>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        &nbsp;
                                    ...
                                    <div class="col-3">
                                        <div class="form-group"> 
                                            ...
                                            <label><?= $bom->kode_formula_produk ?></label>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="jumlah_produksi" class="text-primary"><b>Volume</b> (kg/pcs)</label><br>
                                            <label><?= number_format($bom->volume_produk_msglow,2,',','.') ?> kg</label>
                                        </div>
                                    </div>
                                </div>
                                <hr>    
                                ...
                                <div class="row ml-0">
                                        <div class="col-6">
                                            ...
                                            <label><?= $bom->ket_bom_produk ?></label>
                                        </div>
                                </div>
                            </div>
                        </div>
