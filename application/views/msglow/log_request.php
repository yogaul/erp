        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Log Request</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?>.</td>
                                            <td><?php echo date('d/m/Y H:i:s',strtotime($key->tanggal_log_msglow)); ?></td>
                                            <td><span class="badge badge-info"><?php echo $key->aksi_log_msglow; ?></span></td>
                                            <td><?php echo $key->user_log_msglow; ?></td>
                                            <td>
                                                <?php
                                                    if ($key->aksi_log_msglow == 'Perubahan Spesifikasi') {
                                                        $desc = explode(',',$key->deskripsi_log_msglow);
                                                        if (!empty($desc)) {
                                                ?>
                                                <ul>
                                                <?php
