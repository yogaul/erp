        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Log Deadline BPOM</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $no++; ?>.</td>
                                            <td><?php echo date('d/m/Y H:i:s',strtotime($key->tanggal_log_bpom_msglow)); ?></td>
                                            <td><span class="badge badge-primary"><?php echo date('d/m/Y',strtotime($key->deadline_log_bpom_msglow)); ?></span></td>
                                            <td><?php echo $key->ket_deadline_log_bpom; ?></td>
                                        </tr>
                                    <?php
                                    } 
                                    ?>
