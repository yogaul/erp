        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form action="<?php echo base_url().'glow/simpan_formula' ?>" method="post" id="form-bom" enctype="multipart/form-data">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="volume_produk" id="volume_produk_pcs" value="<?= $data->spesifikasi_volume/1000 ?>">
                                            <input type="text" name="nama_produk" required="" class="form-control" value="<?= $data->usulan_nama_produk ?>" readonly>
                                        </div>
                                        <div class="form-group"> 
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="volume_produk_text" required="" class="form-control" value="<?= number_format($data->spesifikasi_volume/1000,2,',','.') ?>" readonly>
                                        </div>
                                        <div class="form-group"> 
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="kode_formula" class="text-primary"><b>Dokumen Formula</b></label>
