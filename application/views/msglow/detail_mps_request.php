                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <label><?= date('d/m/Y', strtotime($mps->tanggal_mps_msglow)) ?></label>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="volume_produk" class="text-primary"><b>Kode Formula </b></label><br>
                                            <label><?= $mps->kode_formula_msglow ?></label>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        &nbsp;
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <label><?= $mps->usulan_nama_produk.' ('.number_format($mps->spesifikasi_volume/1000,2,',','.').' Kg)' ?></label>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="jumlah_produksi" class="text-primary"><b>Jumlah Produksi</b> (Pcs)</label><br>
                                            <label><?= number_format($mps->jumlah_produksi_msglow,0,',','.') ?> pcs</label>
                                        </div>
                                    </div>
                                </div>
                                <hr>    
                                ...
                                <div class="row ml-0">  
                                        <div class="col-6">
                                            ...
                                            <label><?= $mps->keterangan_mps_msglow ?></label>
                                        </div>
                                </div>
                            </div>
                        </div>
