        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Daftar Bahan Order (Bahan <?php echo $this->session->userdata('kategori'); ?>)</h1>
                    <!-- DataTales Example -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                               <td width="20">
                                                <?php 
                                                    if ($value->kuantitas == $value->datang) {
                                                ?>
                                                    <a href="#!" class="btn btn-sm btn-success"><i class="fas fa-check"></i> Selesai</a>
                                                <?php
                                                    }else{
                                                ?>
                                                    <a href="#!" onclick="show_detail('<?php echo $value->id_detail_order; ?>')" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editModal" data-backdrop="static" data-keyboard="false" disabled><i class="fas fa-edit"></i> Edit</a>
                                                <?php
                                                    }
                                                 ?>
                                                </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="sudah_datang">
                                ...
                                <input class="form-control" id="sudah_datang_modal" type="text" name="sudah_datang" readonly="">
                            </div>
                            <div class="form-group">
                                <label for="bahan_datang" class="text-primary"><b>Jumlah Bahan Datang Baru</b></label>
                                <input class="form-control" type="number" step=".01" name="bahan_datang" placeholder="Masukkan jumlah bahan..." required="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="keterangan_datang" rows="3" placeholder="Keterangan..."></textarea>
                            </div>
                        </div>
