        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Buat Mutasi Penjualan</h1>

                    <!-- DataTales Example -->
                    <form action="<?php echo base_url().'mutasi/simpan_penjualan/' ?>" method="post" id="form-mutasi-penjualan">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="kategori" id="kategori_mutasi_penjualan">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="no_sjp_penjualan" class="text-primary"><b>No. Surat Jalan</b></label>
                                            <input type="text" name="no_sjp_penjualan" required="" class="form-control" value="<?= $nomor_sjp ?>" placeholder="Nomor surat jalan">
                                        </div>
                                        <div class="form-group">
                                            <label for="tujuan_pengiriman" class="text-primary"><b>Tujuan Pengiriman</b></label>
                                            <select name="tujuan_pengiriman" class="form-control" required="">
                                                <?php
                                                    foreach ($tujuan as $value) {
                                                ?>
                                                <option value="<?= $value->id_tujuan_pengiriman ?>"><?= $value->nama_tujuan_pengiriman ?></option>
                                                <?php
                                                    }
                                                ?>
                                            </select>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tableBarangMutasi" width="100%" cellspacing="0">
                                        ...
                                        <tbody id="data_order">
                                            <tr>
                                                <td colspan="5" align="center" class="dataTables_empty">Tidak ada produk yang dipilih</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="row ml-0">
                                        <div class="col-6">
                                            <label for="catatan_mutasi_penjualan" class="text-primary"><b>Catatan</b></label>
                                            <!-- <textarea name="catatan" id="ckeditor" class="ckeditor"></textarea> -->
                                            <textarea name="catatan_mutasi_penjualan" rows="6" class="form-control" placeholder="Tambahkan catatan..."></textarea><br>
                                        </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">&nbsp;</div>
...
<script>
    ...
    CKEDITOR.replace('catatan_mutasi_penjualan');
    ...
    function status_keterangan(){
        let kategori = $('#kategori_mutasi_penjualan').val();
        ...
        $(".delete-row").click(function(){
            ...
            if (cek_barang == 0) {
                ...
                $('input[name="record"]:checked').each(function() {   
                    ...
                    if($('#data_order').html() == ""){
                        $("#data_order").html('<tr><td colspan="5" align="center" class="dataTables_empty">Tidak ada barang yang di pilih</td></tr>');
                        $('.delete-row').attr('hidden', 'true');
                    }
                });
                status_table();
        ...
        $('#id_qr_scan').keydown(function (event) { 
            ...
            if (kode == '') {
                ...
                if (qr_code.includes(kode)) {
                    ...
                    if (event.keyCode === 13) {
                        $.ajax({
                            url: "<?php echo base_url('order/json_detail_qr_penjualan') ?>",
                            type: 'POST',
                            dataType: 'JSON',
                            data: {id: kode},
                            success : function(res){
                                if(res.status == '1'){
                                    let mkategori = $('#kategori_mutasi_penjualan').val();
                                    if (mkategori !== '') {
                                        if (mkategori !== res.kategori) {
                                            ...
                                            if (konfirmasi == true) {
                                                qr_code = [];
                                                qr_code.push(kode);
                                                $('#kategori_mutasi_penjualan').val(res.kategori);
