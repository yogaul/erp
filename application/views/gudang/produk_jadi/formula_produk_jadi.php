...
<head>
    ...
    <title>PT. KOSME - Formula</title>

    <?php $this->load->view('partials/head', FALSE);?>s
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Daftar Formula Produk !</h1>
                                            ...
                                            <td width="100">
                                                <div class="dropdown show">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    ...
                                                    ?>
                                                    <a href="<?= base_url().'glow/mformula/'.$key->id_produk_msglow ?>" class="dropdown-item"><i class="fa fa-flask"></i> Formula</a>
                                                    <?php
                                                        }
                                                    ?>
