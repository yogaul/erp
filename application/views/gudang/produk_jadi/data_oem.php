        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Daftar Produk OEM Kosme !</h1>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="nama_msglow_modal" name="nama_produk" required="" placeholder="Nama produk Ms Glow...">
