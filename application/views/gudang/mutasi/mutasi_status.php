        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Daftar Mutasi Status : <?php echo $status; ?></h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <!-- <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="tab1" data-toggle="tab" href="#bakuPanel" role="tab">Mutasi Bahan Baku</a>
                          <li>
                          <li class="nav-item">
                            <a class="nav-link" id="tab2" data-toggle="tab" href="#kemasPanel" role="tab">Mutasi Bahan Kemas</a>
                          <li>
                          <li class="nav-item">
                            <a class="nav-link" id="tab3" data-toggle="tab" href="#lainPanel" role="tab">Mutasi Lain-lain</a>
                          <li>
                        </ul>
                        <div class="card-body">
                            ...
                            <div class="tab-pane fade show active" id="bakuPanel" role="tabpanel">
                                ...
                                <table class="table table-bordered" id="tableBaku" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Tanggal</th>
                                            <th>Shift</th>
                                    ...
                                    <tbody>
                                    <?php foreach ($mutasi_baku as $key) {
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown show">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    ...
                                                    <a href="#!" onclick="show_modal(<?php echo $key->id_mutasi; ?>)" class="dropdown-item"><i class="fa fa-eye"></i> Detail</a>
                                                  </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="tab-pane fade" id="kemasPanel" role="tabpanel">
                                 <div class="table-responsive">
                                <table class="table table-bordered" id="tableKemas" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Tanggal</th>
                                            <th>Shift</th>
                                    ...
                                    <tbody>
                                    <?php foreach ($mutasi_kemas as $key) {
                                    ?>
                                        <tr>
                                            <td><?php echo date('d/m/Y',strtotime($key->tanggal_mutasi)); ?></td>
                                            <td><?php echo $key->shift; ?></td>
                            ...
                            <div class="tab-pane fade" id="lainPanel" role="tabpanel">
                                <div class="table-responsive">
                                <table class="table table-bordered" id="tableLain" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Tanggal</th>
                                            <th>Shift</th>
                                    ...
                                    <tbody>
                                    <?php foreach ($mutasi_lain as $key) {
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->status_mutasi_lain; ?></td>
                                            <td>
                                                <div class="dropdown show">
                                                  <a class="btn btn-sm btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Tindakan
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    ...
                                                    <a onclick="deleteConfirm('<?php echo base_url().'mutasi/hapus_lain/'.$key->id_mutasi_lain ?>')"
                                                        href="#!" class="dropdown-item"><i class="fa fa-trash"></i> Hapus</a>
                                                    <a href="#!" onclick="show_modal(<?php echo $key->id_mutasi_lain; ?>)" class="dropdown-item"><i class="fa fa-eye"></i> Detail</a>
                                                  </div>
                                                </div>
                                            </td>
                                        </tr>
