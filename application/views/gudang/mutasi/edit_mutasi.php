        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Ubah Mutasi Bahan <?php echo $tipe_mutasi; ?></h1>

                    <!-- DataTales Example -->
                    <form action="<?php echo base_url().'mutasi/update' ?>" method="post" accept-charset="utf-8">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_mutasi" required="" class="form-control" id="datepicker" value="<?php echo $value->tanggal_mutasi; ?>">
                                            <input type="hidden" name="id_mutasi" value="<?php echo $value->id_mutasi; ?>">
                                            <input type="hidden" name="request" value="<?php echo $request; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="shift" class="text-primary"><b>Shift</b></label>
                                            <select name="shift" class="form-control" required="">
                                                <option value="1" <?php if($value->shift == '1'){echo "selected";} ?>>1</option>
                                                <option value="2" <?php if($value->shift == '2'){echo "selected";} ?>>2</option>
                                                <option value="3" <?php if($value->shift == '3'){echo "selected";} ?>>3</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_produk_jadi" class="text-primary"><b>Nama Produk</b></label>
                                            <input type="text" class="form-control" name="nama_produk_jadi" placeholder="Masukkan nama produk..." value="<?php echo $value->nama_produk_jadi; ?>" required="">
                                        </div>
                                        <?php
                                            }
                                         ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="jumlah_batch_text" class="form-control" required="" class="form-control" placeholder="Masukkan jumlah batch..." onkeyup="format_batch()" value="<?php echo $value->jumlah_batch; ?>">
                                            <input type="hidden" name="jumlah_batch" id="jumlah_batch" value="<?php echo $value->jumlah_batch; ?>">
                                        ...
                                        <div class="form-group" id="div-nomor-batch">
                                            ...
                                            <div class="contain">
                                                <?php 
                                                    $angka=1;
                                                    foreach ($data_batch as $value) {
                                                ?>
                                                <input type='text' class='form-control mb-1' name='no_batch[]' value="<?php echo $value->no_batch; ?>" placeholder="<?php echo "Masukkan nomor batch ke-$angka"; ?>" required>
                                                <?php
                                                    $angka++;
                                                    }
                                                 ?>
                                ...
                                <div>
                                    <a class="btn btn-sm btn-danger" id="delete-row">Hapus Baris</a>
                                </div><br>
                                <div class="row ml-0">
                                        <div class="col-6">
                                            <label for="catatan_mutasi" class="text-primary"><b>Catatan</b></label>
                                            <textarea name="catatan_mutasi" rows="6" class="form-control" placeholder="Tambahkan catatan..."><?php foreach ($data_mutasi as $value) {
                                                echo $value->catatan_mutasi;
                                            } ?></textarea><br>
                                        </div>
                                </div>
                                <div class="row">
