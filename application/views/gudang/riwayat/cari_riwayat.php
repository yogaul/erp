        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h6 text-gray-800">Tanggal <?php echo date('d/m/Y', strtotime($start)).' - '.date('d/m/Y', strtotime($end)); ?></h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <form action="<?= base_url().'export/search_history' ?>" method="post">
                                <a href="<?php echo base_url().'order/history_kedatangan/'.$kategori; ?>" class="btn btn-sm btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
                                <input type="hidden" name="start" id="start-search" value="<?= $start ?>">
                                <input type="hidden" name="end" id="end-search" value="<?= $end ?>">
                                ...
                                <table class="table table-bordered" id="tableHistory" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $tanggal = (is_null($key->tanggal_kedatangan)) ? '-' : date('d/m/Y',strtotime($key->tanggal_kedatangan)); ?></td>
