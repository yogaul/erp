            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <form action="<?php echo base_url().'sjp/simpan_glow'; ?>" method="POST">
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-3">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label for="produk_so" class="text-primary" id="produk"><b>Produk MS Glow</b></label>
                                            <select name="produk_so" required="" class="form-control" id="produk_so">
                                                <?php
                                                    foreach ($produk_glow as $value) {
                                                ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="alamat_sjp" placeholder="Alamat penerima..." required="" style="height: 120px;"><?= $alamat ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>    
