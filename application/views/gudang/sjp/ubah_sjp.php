        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Ubah Surat Jalan Pengiriman (SJP)</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <form action="<?php echo base_url().'sjp/edit'; ?>" method="POST">
                        <div class="card-body">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id_spp" value="<?php echo $id_sjp; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="produk_so" required="" class="form-control" id="produk_so">
                                                <?php
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="telp_sjp" placeholder="Telp penerima..." value="<?php echo $data_spp->telp_customer; ?>" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="alamat_sjp" class="text-primary"><b>Alamat Pengiriman</b></label>
                                            <textarea class="form-control" name="alamat_sjp" placeholder="Alamat penerima..." required="" style="height: 120px;"><?php echo $data_spp->alamat_perusahaan_kirim; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <br>    
    ...
    $(document).ready(function() {
        ...
        $("#simpan-pilih").click(function(event) {
            ...
            if (values == null) {
                ...
                $.ajax({
                  url: "<?php echo base_url('sample/json_row_sjp'); ?>",
                  type: 'POST',
                  dataType: 'JSON',
                  data: {id: values},
