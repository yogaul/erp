        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Log Mutasi Bahan <?php echo $kategori; ?></h1>
                    <h1 class="h6 text-gray-800">Tanggal <?php echo $start.' - '.$end; ?></h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                             <a href="<?php echo base_url().'mlog/index/'.lcfirst($kategori); ?>" class="btn btn-sm btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                        <div class="card-body">
