    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                <h1 class="h4 mb-2 text-gray-800">Buat Kategori</h1><hr>
                <form action="<?php echo base_url().'kategori/simpan' ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deskripsi_kategori" class="form-control" required="" placeholder="Masukkan deskripsi kategori...">    
                    </div>
                    <div class="form-group">
